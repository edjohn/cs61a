...
class QueenAnt(ScubaThrower):
    ...
    def action(self, gamestate):
        ...
        while cur_place != None:
            ant = cur_place.ant
            if ant:
                if isinstance(ant, ContainerAnt) and ant.contained_ant and not ant.contained_ant.queen_buffed:
                    ant.contained_ant.damage *= 2
                    ant.contained_ant.queen_buffed = True
